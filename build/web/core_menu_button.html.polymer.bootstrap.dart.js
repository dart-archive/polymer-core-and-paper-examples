...
$.iE=new O.ut(y)
$.ok=!0
$.UD().FV(0,[H.J(new A.W(C.KK,C.ai),[null]),H.J(new A.W(C.l3,C.tY),[null]),H.J(new A.W(C.R,C.j3),[null]),H.J(new A.W(C.pP,C.SN),[null]),H.J(new A.W(C.dn,C.Zr),[null]),H.J(new A.W(C.dK,C.ES),[null]),H.J(new A.W(C.Mw,C.B0),[null]),H.J(new A.W(C.aL,C.Td),[null]),H.J(new A.W(C.MZ,C.X6),[null]),H.J(new A.W(C.J2,C.JR),[null]),H.J(new A.W(C.ad,C.Uq),[null]),H.J(new A.W(C.av,C.mt),[null]),H.J(new A.W(C.Py,C.h8),[null]),H.J(new A.W(C.wn,C.jY),[null]),H.J(new A.W(C.DW,C.Sz),[null]),H.J(new A.W(C.IN,C.DS),[null]),H.J(new A.W(C.T0,C.zw),[null]),H.J(new A.W(C.Eq,C.fL),[null]),H.J(new A.W(C.xa,Q.EL()),[null])])
A.Ok()},"$0","ZR",0,0,1],
L:{
"^":"r:2;",
...
J.fs(z,new Q.xz(["Apple fritter","Croissant","Donut","Financier","Jello","Madeleine","Pound cake","Pretzel","Sfogliatelle"]))
z.toString
y=new W.DM(z,z).p(0,"template-bound")
H.J(new W.Ov(0,y.Q,y.a,W.Yt(new Q.CQ()),y.b),[H.Kp(y,0)]).P6()},null,null,2,0,null,84,"call"]},
CQ:{
"^":"r:2;",
$1:[function(a){var z,y
z=H.Go(document.querySelector("#toggleCollapse"),"$isQW")
z.toString
y=H.J(new W.eu(z,"click",!1),[null])
H.J(new W.Ov(0,y.Q,y.a,W.Yt(new Q.Ki()),y.b),[H.Kp(y,0)]).P6()},null,null,2,0,null,84,"call"]},
Ki:{
"^":"r:2;",
...
if(y!=null)for(x=C.xB.Fr(y,$.FF()),x=H.J(new J.m1(x,x.length,0,null),[H.Kp(x,0)]),w=this.c;x.D();){v=J.nA(x.c)
if(v==="")continue
u=$.r5().Q.f.p(0,v)
t=u!=null
if(t){s=L.hk([u])
